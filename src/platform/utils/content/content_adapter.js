...
export class ContentAdapter {
  ...
  adaptMultiple(attachments) {
    ...
    /** @type {Array<{text: string, structuredInfo: object}>} */
    const results = [];
    for (const att of attachments) {
      results.push(this.adaptToText(/** @type {{type:'image'|'audio'|'file', path:string, filename?:string, size?:number, mimeType?:string}} */(att)));
    }
    return results;
  }
