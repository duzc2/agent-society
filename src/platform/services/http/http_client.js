...
export class HttpClient {
  /**
   * @param {{logger?: import("../../utils/logger/logger.js").ModuleLogger, maxResponseBodyLogSize?: number}} options
   */
  constructor(options = {}) {
...
/**
 * 创建 HTTP 客户端实例
 * @param {{logger?: import("../../utils/logger/logger.js").ModuleLogger}} options
 * @returns {HttpClient}
 */
