...
export class RuntimeTools {
  ...
  registerBuiltinToolGroups() {
    ...
    const toolGroupMapping = {
      ...
      create_group: "org_management",
      send_group_message: "org_management",
      invite_to_group: "org_management",
      leave_group: "org_management",
      dissolve_group: "org_management",
      get_group_info: "org_management",
      list_my_groups: "org_management",
