...
class MimeTypeRegistry {
  ...
  private registerDefaultHandlers(): void {
    ...
    // JSON 与 JSONL 渲染器（兼容 application/jsonl、x-ndjson、text/jsonl 等变种写法）
    this.register({
      mimePattern: ['application/json', 'application/jsonl', 'application/x-jsonl', 'application/x-ndjson', 'text/jsonl', 'text/x-jsonl'],
