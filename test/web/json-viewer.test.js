      ...
      fc.property(
        ...
        (obj) => {
          ...
          for (const key of keys) {
            assert.ok(viewer.renderedKeys.includes(key));
          }
      ...
      fc.property(
        ...
        (arr) => {
          ...
          for (let i = 0; i < arr.length; i++) {
            assert.ok(viewer.renderedArrayIndices.includes(`[${i}]`));
          }
    ...
    fc.assert(
      fc.property(
        ...
        (obj) => {
          ...
          if (rootCount) {
            assert.strictEqual(rootCount.count, Object.keys(obj).length);
          }
    ...
    fc.assert(
      fc.property(
        ...
        (arr) => {
          ...
          if (rootCount) {
            assert.strictEqual(rootCount.count, arr.length);
          }
      ...
      fc.property(
        ...
        (obj) => {
          ...
          if (nodeIds.length > 0) {
            ...
            // 初始状态：展开
            assert.strictEqual(viewer.expandedNodes.has(nodeId), true);

            // 收缩
            viewer.toggleNode(nodeId);
            assert.strictEqual(viewer.expandedNodes.has(nodeId), false);
      ...
      fc.property(
        ...
        (obj, toggleCount) => {
          ...
          if (nodeIds.length > 0) {
            ...
            assert.strictEqual(viewer.expandedNodes.has(nodeId), expectedState);
          }
    ...
    fc.assert(
      fc.property(
        ...
        (fieldName) => {
          ...
          assert.strictEqual(copied, fieldName);
    ...
    fc.assert(
      fc.property(
        ...
        (value) => {
          ...
          assert.strictEqual(copied, value);
    ...
    fc.assert(
      fc.property(
        ...
        (value) => {
          ...
          assert.strictEqual(copied, String(value));
    ...
    fc.assert(
      fc.property(
        ...
        (value) => {
          ...
          assert.deepStrictEqual(parsed, JSON.parse(JSON.stringify(value)));
    ...
    fc.assert(
      fc.property(
        ...
        (arr) => {
          ...
          const parsed = JSON.parse(copied);
          // Normalize to handle null-prototype objects from fc.dictionary
          assert.deepStrictEqual(parsed, JSON.parse(JSON.stringify(arr)));
    ...
    fc.assert(
      fc.property(
        ...
        (str) => {
          ...
          assert.strictEqual(truncated.substring(0, 100), str.substring(0, 100));
    ...
    fc.assert(
      fc.property(
        ...
        (str) => {
          ...
          assert.strictEqual(truncated, str);
    ...
    fc.assert(
      fc.property(
        ...
        (str) => {
          ...
          assert.strictEqual(span.title, str);
